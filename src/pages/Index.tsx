    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-white px-6 pt-16">
          ...
          >
            <motion.span
              className="block text-sm md:text-base font-medium uppercase tracking-[0.2em] mb-6"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <motion.h1
              className="text-5xl md:text-7xl lg:text-8xl font-playfair font-bold mb-8 leading-none negative-tracking"
            ...
            <motion.p
              className="text-xl md:text-2xl mb-10 max-w-2xl mx-auto text-shadow font-light tracking-wide"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <Link
                to="/portfolio"
                className="bg-white hover:bg-white/90 text-black px-8 py-4 rounded-none transition-all duration-300 hover:shadow-lg flex items-center justify-center text-sm font-medium tracking-wide"
              >
                View Portfolio <ArrowRight size={16} className="ml-2" />
              </Link>
              <Link
                to="/blog"
                className="bg-transparent hover:bg-white/10 text-white border border-white/40 px-8 py-4 rounded-none transition-all duration-300 hover:shadow-lg text-sm font-medium tracking-wide"
              >
                Read Uko nageze
              </Link>
            </motion.div>
              ...
              <AnimatedSection>
                <div className="relative">
                  ...
                  <ImageWithLoading
                    ...
                    className="rounded-none shadow-xl z-10 relative"
                    width="100%"
                    height="auto"
                    clickable={true}
                  />
      ...
      <section className="py-32 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-16">
            <Link
              to="/blog"
              className="inline-flex items-center justify-center px-8 py-4 border border-black text-black font-medium rounded-none hover:bg-black hover:text-white transition-colors duration-300"
            >
                ...
                <div className={`rounded-none overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 ${index === 0 || index === 3 || index === 4 || index === 7 ? 'row-span-2' : ''}`}>
                  <div className="relative group h-full">
                    ...
                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <Link 
                        to="/portfolio"
                        className="px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/30 text-white rounded-none hover:bg-white/20 transition-colors duration-300"
                      >
                        View Gallery
                      </Link>
                    </div>
      ...
      <section className="py-32 px-6 bg-black text-white">
        <div className="max-w-5xl mx-auto text-center">
          <AnimatedSection>
            ...
            <Link
              to="/contact"
              className="inline-flex items-center justify-center px-10 py-4 bg-white text-black font-medium rounded-none hover:bg-white/90 transition-colors duration-300 shadow-lg tracking-wide"
            >
              Get in Touch
            </Link>
          </AnimatedSection>
